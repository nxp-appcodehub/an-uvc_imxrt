...
STRUCT_PACKED
struct _usb_device_video_uncompressed_payload_header_struct
{
...
typedef struct _usb_device_video_uncompressed_payload_header_struct usb_device_video_uncompressed_payload_header_struct_t;
