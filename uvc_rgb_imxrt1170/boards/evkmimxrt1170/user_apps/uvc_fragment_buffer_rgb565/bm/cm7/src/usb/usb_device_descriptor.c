...
usb_device_interface_struct_t g_UsbDeviceVideoControlInterface[] = {{
    USB_VIDEO_CAMERA_CONTROL_INTERFACE_ALTERNATE_0, /* Alternate setting value */
    {
...
usb_device_interface_struct_t g_UsbDeviceVideoStreamInterface[] = {
    {
        USB_VIDEO_CAMERA_STREAM_INTERFACE_ALTERNATE_0, /* Alternate setting value is zero*/
        {
    ...
    {
        USB_VIDEO_CAMERA_STREAM_INTERFACE_ALTERNATE_1, /* Alternate setting value is one */
        {
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_VIDEO_CAMERA_CONTROL_INTERFACE_ALTERNATE_0, /* Index of the interface setting */
    ...
    USB_VIDEO_CAMERA_STREAM_INTERFACE_ALTERNATE_0, /* Index of the interface setting */
    ...
    USB_DESCRIPTOR_TYPE_INTERFACE,                   /* INTERFACE Descriptor */
    USB_VIDEO_CAMERA_STREAM_INTERFACE_INDEX, /* Index of stream interface */
    USB_VIDEO_CAMERA_STREAM_INTERFACE_ALTERNATE_1, /* Index of the interface setting */
