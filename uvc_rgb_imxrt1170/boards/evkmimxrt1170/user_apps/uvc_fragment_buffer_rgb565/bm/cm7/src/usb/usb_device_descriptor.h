...
#define USB_VIDEO_CAMERA_CONTROL_INTERFACE_ALTERNATE_COUNT (1U)
#define USB_VIDEO_CAMERA_CONTROL_INTERFACE_ALTERNATE_0 (0U)
...
#define USB_VIDEO_CAMERA_STREAM_INTERFACE_ALTERNATE_COUNT (2U)
#define USB_VIDEO_CAMERA_STREAM_INTERFACE_ALTERNATE_0 (0U)
#define USB_VIDEO_CAMERA_STREAM_INTERFACE_ALTERNATE_1 (1U)
...
#define HS_STREAM_IN_PACKET_SIZE (935)
...
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_DATA_BITS (UVC_FRAME_BUFFER_BPP)
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_WIDTH (UVC_FRAME_WIDTH)
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_HEIGHT (UVC_FRAME_HEIGHT)
